...
<div class="container" style="background: #ffffff; margin-top: 80px; margin-left: 80px;">
    ...
    <div class="row">
        <div align="center">
            <img src="<c:url value="/assets/author/ic_icon_author_welcome.png"/>" style="width:300px; height:100px;">
        </div>
        <br>
        <div align="center">
            <img src="<c:url value="/assets/author/ic_icon_author.png"/>" style="width:300px; height:350px;">
        </div>
