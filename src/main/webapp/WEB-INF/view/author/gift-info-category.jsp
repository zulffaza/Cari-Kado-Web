...
<div class="container-fluid" style="background: #ffffff; margin-top: 120px; margin-left: 20px; margin-right: 20px;">
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="<c:url value="/dashboard/author/gift-info-category/add"/>">
                ...
                <c:otherwise>
                    <c:forEach items="${giftInfoCategories}" var="giftInfoCategory" varStatus="each">
                        <tr>
                            ...
                            <td>
                                <a href="<c:url value="/dashboard/author/gift-info-category/add/${giftInfoCategory.id}"/>">
                                    <button class="btn btn-primary btn-xs" style="width: 70px; height: 28px;">
                                        <i aria-hidden="true" class="fa fa-pencil-square-o"></i> Update
                                    </button>
                                </a>
                                <a href="<c:url value="/dashboard/author/gift-info-category/delete/${giftInfoCategory.id}"/>">
    ...
    <ul class="pagination">
        <c:if test="${page != 1}">
            <li>
                <a href="<c:url value="/dashboard/author/gift-info-category/1"/>">&laquo; first</a>
            </li>
            <li>
                <a href="<c:url value="/dashboard/author/gift-info-category/${page - 1}"/>">&lsaquo; previous</a>
            </li>
        </c:if>

        <li class="active">
            <a href="<c:url value="/dashboard/author/gift-info-category/${page}"/>">${page}</a>
        </li>

        <c:if test="${lastPage != page}">
            <li>
                <a href="<c:url value="/dashboard/author/gift-info-category/${page + 1}"/>">next &rsaquo;</a>
            </li>
            <li>
                <a href="<c:url value="/dashboard/author/gift-info-category/${lastPage}"/>">last &raquo;</a>
            </li>
        </c:if>
    </ul>
</div>
