...
<div class="container">
    <p style="font-size: 35px; color: #66060b;">
        <b>${user.userName.firstName} ${user.userName.middleName} ${user.userName.lastName} - <a href="/dashboard/author/gift-info-category/1">GiftInfoCategory</a></b>
    </p>
    ...
    <form:form class="form-horizontal" name="addGiftInfoCategory" method="post" action="/dashboard/author/gift-info-category/add">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="role-name" name="giftInfoCategoryName" placeholder="Enter GiftInfoCategory name" value="${giftInfoCategory.name}" required="required">
            </div>
        </div>
