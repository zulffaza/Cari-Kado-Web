...
<nav class="navbar navbar-fixed-top" style="background: #A91E31;">
    <div class="navbar-brand">
        <img src="<c:url value="/assets/admin/fullicon1.png"/>" width="176" height="47" style="margin-bottom:10px">
    </div>
    <div>
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <center><img src="<c:url value="/assets/admin/ic_icon_login_admin.png"/>" style="width:309px; height:121px;"
                                     alt="Login Admin"></center>
                    </div>

                    <div class="item">
                        <center><img src="<c:url value="/assets/author/ic_icon_login_author.png"/>" style="width:309px; height:121px;"
                                     alt="Login Author">
                    </div>

                    <div class="item">
                        <center><img src="<c:url value="/assets/cs/ic_icon_login_cs.png"/>" style="width:309px; height:121px;"
                                     alt="Login Customer Service">
                    </div>
                </div>
