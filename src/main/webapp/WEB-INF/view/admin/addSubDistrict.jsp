...
<html>
    <head>
        <c:choose>
            ...
            <c:url var="form_action" value="/dashboard/admin/sub-district/add"/>
    ...
    <body>
        ...
        <div class="container">
            <p style="font-size: 35px; color: #66060b;">
                <b>${user.userName.firstName} ${user.userName.middleName} ${user.userName.lastName} - <a href="<c:url value="/dashboard/admin/sub-district/1"/>">SUB DISTRICT</a></b>
            </p>
            ...
            <form:form class="form-horizontal" name="addSubDistrict" method="post" action="${form_action}">
            ...
            <script src="<c:url value="/js/admin/addSubDistrict.js"/>"></script>
    </body>
</html>
