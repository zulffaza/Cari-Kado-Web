...
<div class="container-fluid" style="background: #ffffff; margin-top: 120px; margin-left: 20px; margin-right: 20px;">
    ...
    <ul class="pagination">
        ...
        <c:if test="${page != 1}">
            <li>
                <a href="/dashboard/admin/city/1">&laquo;</a>
            </li>
            <li>
                <a href="/dashboard/admin/city/${page - 1}">&lsaquo;</a>
            </li>
        </c:if>
        ...
        <c:if test="${lastPage != page}">
            <li>
                <a href="/dashboard/admin/city/${page + 1}">&rsaquo;</a>
            </li>
            <li>
                <a href="/dashboard/admin/city/${lastPage}">&raquo;</a>
            </li>
        </c:if>
    </ul>
</div>
