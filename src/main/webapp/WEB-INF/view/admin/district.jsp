        ...
        <div class="container-fluid" style="background: #ffffff; margin-top: 120px; margin-left: 20px; margin-right: 20px;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="/dashboard/admin/district/add">
            ...
            <ul class="pagination">
                <c:if test="${page != 1}">
                    <li>
                        <a href="/dashboard/admin/district/1">&laquo; first</a>
                    </li>
                    <li>
                        <a href="/dashboard/admin/district/${page - 1}">&lsaquo; previous</a>
                    </li>
                </c:if>

                <li class="active">
                    <a href="/dashboard/admin/district/${page}">${page}</a>
                </li>

                <c:if test="${lastPage != page}">
                    <li>
                        <a href="/dashboard/admin/district/${page + 1}">next &rsaquo;</a>
                    </li>
                    <li>
                        <a href="/dashboard/admin/district/${lastPage}">last &raquo;</a>
                    </li>
                </c:if>
            </ul>
        </div>
