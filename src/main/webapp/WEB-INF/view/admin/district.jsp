    ...
    <nav class="navbar navbar-fixed-top" style="background: #A91E31;">
        ...
        <div class="container-fluid" style="background: #ffffff; margin-top: 120px; margin-left: 20px; margin-right: 20px;">
            <div class="row">
                <div class="col-md-12">
                    <p style="font-size: 35px; color: #66060b;">
                        <b>${user.userName.firstName} ${user.userName.middleName} ${user.userName.lastName} - DISTRICT</b>
                    </p>
                    ...
                    <br>
                    <a href="<c:url value="/dashboard/admin/district/add"/>">
                            ...
                            <c:otherwise>
                                <c:forEach items="${districts}" var="district" varStatus="each">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<c:url value="/dashboard/admin/district/add/${district.id}"/>">
                                                <button class="btn btn-primary btn-xs" style="width: 70px; height: 28px;">
                                                    <i aria-hidden="true" class="fa fa-pencil-square-o"></i> Update
                                                </button>
                                            </a>
                                            <a href="<c:url value="/dashboard/admin/district/delete/${district.id}"/>">
            ...
            <ul class="pagination">
                <c:if test="${page != 1}">
                    <li>
                        <a href="<c:url value="/dashboard/admin/district/1"/>">&laquo; first</a>
                    </li>
                    <li>
                        <a href="<c:url value="/dashboard/admin/district/${page - 1}"/>">&lsaquo; previous</a>
                    </li>
                </c:if>

                <li class="active">
                    <a href="<c:url value="/dashboard/admin/district/${page}"/>">${page}</a>
                </li>

                <c:if test="${lastPage != page}">
                    <li>
                        <a href="<c:url value="/dashboard/admin/district/${page + 1}"/>">next &rsaquo;</a>
                    </li>
                    <li>
                        <a href="<c:url value="/dashboard/admin/district/${lastPage}"/>">last &raquo;</a>
                    </li>
                </c:if>
            </ul>
        </div>
