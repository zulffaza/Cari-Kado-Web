...
<html>
    <head>
        <c:choose>
            ...
            <c:url var="form_action" value="/dashboard/admin/user/add"/>
    ...
    <nav class="navbar navbar-fixed-top" style="background: #A91E31;">
        ...
        <div class="container">
            <p style="font-size: 35px; color: #66060b;">
                <b>${user.userName.firstName} ${user.userName.middleName} ${user.userName.lastName} - <a href="<c:url value="/dashboard/admin/user/1"/>">USER</a></b>
            </p>
            ...
            <form:form class="form-horizontal" name="addUser" method="post" action="${form_action}">
        ...
        <script src="<c:url value="/js/admin/addUser.js"/>"></script>
    </body>
</html>
