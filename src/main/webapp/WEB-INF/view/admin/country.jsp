        ...
        <div class="container-fluid" style="background: #ffffff; margin-top: 120px; margin-left: 20px; margin-right: 20px;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <br>
                    <a href="<c:url value="/dashboard/admin/country/add"/>">
            ...
            <ul class="pagination">
                <c:if test="${page != 1}">
                    <li>
                        <a href="<c:url value="/dashboard/admin/country/1"/>">&laquo; first</a>
                    </li>
                    <li>
                        <a href="<c:url value="/dashboard/admin/country/${page - 1}"/>">&lsaquo; previous</a>
                    </li>
                </c:if>

                <li class="active">
                    <a href="<c:url value="/dashboard/admin/country/${page}"/>">${page}</a>
                </li>

                <c:if test="${lastPage != page}">
                    <li>
                        <a href="<c:url value="/dashboard/admin/country/${page + 1}"/>">next &rsaquo;</a>
                    </li>
                    <li>
                        <a href="<c:url value="/dashboard/admin/country/${lastPage}"/>">last &raquo;</a>
                    </li>
                </c:if>
            </ul>
        </div>
