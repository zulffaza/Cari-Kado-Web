INSERT INTO country (country_name) VALUE ('Indonesia');
...
INSERT INTO district (city_id, district_name) VALUES
  ...
  (1, 'Kaway XVI'),
  (1, 'Meureubo'),
  (1, 'Pante Ceureumen (Pantai Ceuremen)'),
  (1, 'Panton Reu'),
  (1, 'Samatiga'),
  (1, 'Sungai Mas'),
  (1, 'Woyla'),
...
INSERT INTO district (city_id, district_name) VALUES
  ...
  (3, 'Indrapuri'),
  (3, 'Ingin Jaya'),
  (3, 'Kota Cot Glie (Kuta Cot Glie)'),
  (3, 'Kota Jantho'),
  (3, 'Kota Malaka (Kuta Malaka)'),
...
INSERT INTO district (city_id, district_name) VALUES
  ...
  (5, 'Kota Bahagia'),
  (5, 'Labuhan Haji'),
  (5, 'Labuhan Haji Barat'),
  (5, 'Labuhan Haji Timur'),
  (5, 'Meukek'),
  (5, 'Pasie Raja'),
  (5, 'Sama Dua'),
  (5, 'Sawang'),
...
>>>>>>> 577da2adcdfcd6fa544692a50539b9fa61f9e964
